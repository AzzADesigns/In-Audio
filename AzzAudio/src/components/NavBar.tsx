...
export const NavBar = () => {
    ...
    return (
        <div className='text-tertiary fixed 2xl:bottom-20 flex justify-center items-center bg-black/50 backdrop-blur-xl h-16 2xl:h-20  w-[80%] 2xl:w-[40%] px-5 2xl:px-16 rounded-full border-4 border-secundary'>
