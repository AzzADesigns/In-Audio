...
export const Text = memo(() => {
    ...
    return (
        <div className="w-full h-full bg-primary md:pb-10 lg:h-96 2xl:pt-10 flex-center  text-tertiary text-xs  md:text-4xl lg:text-3xl xl:text-3xl 2xl:text-5xl font-dots [&_span]:text-secundary">
