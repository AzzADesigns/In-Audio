...
export const Text = () => {
    return (
        <div className="w-full h-full  md:pb-10 lg:h-96 2xl:pt-10 flex-center  text-tertiary text-md  md:text-4xl xl:text-3xl 2xl:text-5xl font-dots [&_span]:text-secundary">
