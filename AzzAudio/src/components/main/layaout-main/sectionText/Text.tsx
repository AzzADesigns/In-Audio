...
export const Text = memo(() => {
    ...
    return (
        <div className="w-full h-full bg-tertiary rounded-xl md:pb-10 xl:pb-14 xl:p-5 lg:h-96 2xl:pt-10 flex-center  text-primary text-xs  md:text-4xl lg:text-3xl xl:text-3xl 2xl:text-5xl font-dots">
