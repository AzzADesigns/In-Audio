...
export const Main = () => {
    ...
    return (
        <main className=" h-full flex bg-violet-900 lg:mt-0 lg:pt-0 flex-center justify-start mb-96 w-full flex-center gap-32 xl:gap-96 ">
            ...
            <div className="w-full h-full bg-red-900 mt-20 xl:mt-96">
                <ListenToMusic/>
            </div>
        </main>
    )
