...
export const Banner = () => {
    return (
        <section className='flex-center w-full mb-96 '>
            <div className='2xl:w-full flex justify-between 2xl:pl-[19%] items-start 2xl:mr-12 pt-20 2xl:pt-0'>
            ...
            <div className='absolute top-36 2xl:static 2xl:h-auto '>
            ...
            <div className='absolute left-[5%] bottom-8'>
                <p className='text-tertiary absolute bottom-96 2xl:relative text-sm 2xl:text-xl font-uniq  tracking-[0.3em]'>“The sound of the unheard”</p>
            </div>
        </section>
    )
}
